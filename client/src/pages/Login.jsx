...
const LoginPage = () => {
  ...
  const handleGoogleSignIn = () => {
    ...
    try {
      ...
      console.log('LoginPage: Cleared localStorage before Google OAuth');
          ...
          {!showResetForm ? (
            <>
              ...
              <button
                ...
                className="w-full bg-white border border-gray-300 text-gray-700 p-3 rounded-full hover:bg-gray-50 transition-all flex items-center justify-center space-x-2 mb-4"
                disabled={isLoading}
              >
